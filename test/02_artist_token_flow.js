...
contract("ArtistTokenFlow", ([artist, hatcher1, hatcher2, buyer1, buyer2, fundingPoolAccountant, fundingPoolAttacker, feeRecipient, lightstreams]) => {
  ...
  it('should create a reserve of Artist tokens', async () => {
    ...
    const tokensAmountExpected = pht2wei((AMOUNT_TO_RAISE_PHT * P0 / DENOMINATOR_PPM));
  ...
  it('should have assigned correct initial contributions to all hatchers', async () => {
    ...
    const lockedInternalExpected = pht2wei(PER_HATCHER_CONTRIBUTION_PHT * P0 / DENOMINATOR_PPM);
    ...
    const lockedInternalExpected2 = pht2wei(PER_HATCHER_CONTRIBUTION_PHT * P0 / DENOMINATOR_PPM);
  ...
  it('should let a hatcher to claim his artist tokens after allocating funds in post-hatch phase', async () => {
    ...
    const preClaimLockedInternalExpected = pht2wei(PER_HATCHER_CONTRIBUTION_PHT * P0 / DENOMINATOR_PPM);
